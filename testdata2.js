...
*/}
    ...
    const [numbertest, SetNumbertest] = useState(70);
        ...
        if (count == 10) {
            if (numbertest <= 50) {
                return (
                    <>
                        <View style={{ flex: 1, justifyContent: 'center' }}>
                            <Progress step={30} steps={100} height={10} />
                            <Text> น้อยกว่า 50 : {numbertest} </Text>
                        </View>
                    </>
                );
            } else if (numbertest <= 55) {
                return (
                    <>
                        <View style={{ flex: 1, justifyContent: 'center' }}>
                            <Progress step={20} steps={100} height={10} />
                            <Text> มากกว่า 50 : {numbertest} </Text>
                        </View>
                    </>
                );
            } else {
                return (
                    <>
                        <View style={{ flex: 1, justifyContent: 'center' }}>
                            <Progress step={5} steps={100} height={10} />
                            <Text> มากกว่า 60 : {numbertest} </Text>
                        </View>
            ...
            if (numbertest <= 100) {
                return (
                    <>
                        <View style={{ flex: 1, justifyContent: 'center' }}>
                            <Progress step={60} steps={100} height={10} />
                            <Text> น้อยกว่า 50 : {numbertest} </Text>
                        </View>
                    </>
                );
            } else if (numbertest <= 110) {
                return (
                    <>
                        <View style={{ flex: 1, justifyContent: 'center' }}>
                            <Progress step={20} steps={100} height={10} />
            ...
            if (count > 10) {
                            ...
                            <View style={styles.container}>
                                <View style={styles.card}>
                                    ...
                                    <View style={{ width: '100%', height: 60 }}>
                                        <View style={{ width: '80%', justifyContent: 'center', height: 30, marginLeft: 40, marginBottom: 5 }}>
                                            <Text style={{ color: '#737373', fontFamily: 'FC_Iconic', fontSize: 18 }}>ระดับความสำเร็จ</Text>
                                            <Progress step={40} steps={100} height={10} />
                                            <Text> มากกว่า 50 : {numbertest} </Text>
                                        </View>
                            ...
                            <View style={styles.container}>
                                <View style={styles.card}>
                                    ...
                                    <View style={{ width: '100%', height: 60 }}>
                                        <View style={{ width: '80%', justifyContent: 'center', height: 30, marginLeft: 40, marginBottom: 5 }}>
                                            <Text style={{ color: '#737373', fontFamily: 'FC_Iconic', fontSize: 18 }}>ระดับความสำเร็จ</Text>
                                            <Progress step={10} steps={100} height={10} />
                                            <Text> มากกว่า : {numbertest} </Text>
                                        </View>
                ...
                return <Text style={{fontSize:300}}> No thing </Text>
            }
